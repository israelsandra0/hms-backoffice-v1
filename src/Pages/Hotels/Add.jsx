    ...
    return (
        <>
            ...
            <Card className="w-4/5 text-center ">
                ...
                <CardContent>
                    <form onSubmit={handleSubmit(refetch)} className="hotelForm w-4/5 text-left">
                        <div className='ml-4'>
                            <div className="p-2">
                                <label htmlFor="name">Name of hotel</label><br />
                            ...
                            <div className="p-2">
                                ...
                                <Input {...register('website')} id="website" className=" outline-none text-black" />
                                <p  className="text-red-700">{errors.website?.message}</p>
                            </div>
                        </div>

                        <Button disabled={!!disabledButton} className=" mt-12 ml-6" type='submit'>{disabledButton ? 'Submitting...' : 'submit'}</Button>
                    </form>
                </CardContent>
            </Card>
        </>
