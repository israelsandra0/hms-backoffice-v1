        ...
        {totalCount > 0 && (
          <div className="relative left-0 size-0 select-none">
            <PopoverTrigger asChild>
              <Button
                variant="ghost"
                className="mt-1 ml-1 flex h-6 gap-1 !px-1.5 py-0 text-neutral-500/80 hover:text-neutral-500/80 data-[active=true]:bg-neutral-100 dark:text-neutral-400/80 dark:hover:text-neutral-400/80 dark:data-[active=true]:bg-neutral-800"
                data-active={open}
...
function BlockComment({
  ...
  return (
    <React.Fragment key={discussion.id}>
      ...
      {!isLast && <div className="h-px w-full bg-neutral-100 dark:bg-neutral-800" />}
    </React.Fragment>
  );
}
