  ...
  return (
    <PlateElement {...props} as="span">
      <InlineCombobox
        ...
        trigger="@">
        <span
          className="inline-block rounded-md bg-neutral-100 px-1.5 py-0.5 align-baseline text-sm ring-neutral-950 focus-within:ring-2 dark:bg-neutral-800 dark:ring-neutral-300">
          <InlineComboboxInput />
        </span>
