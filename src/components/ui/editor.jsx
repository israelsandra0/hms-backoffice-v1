...
const editorVariants = cva(cn(
  ...
  'placeholder:text-neutral-500/80 **:data-slate-placeholder:!top-1/2 **:data-slate-placeholder:-translate-y-1/2 **:data-slate-placeholder:text-neutral-500/80 **:data-slate-placeholder:opacity-100! dark:placeholder:text-neutral-400/80 dark:**:data-slate-placeholder:text-neutral-400/80',
  '[&_strong]:font-bold'
), {
  defaultVariants: {
    variant: 'default',
