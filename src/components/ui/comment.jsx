  ...
  return (
    <div
      ...
      <div className="relative flex items-center">
        ...
        <div
          className="text-xs leading-none text-neutral-500/80 dark:text-neutral-400/80">
          <span className="mr-1">
        ...
        {isMyComment && (hovering || dropdownOpen) && (
          <div className="absolute top-0 right-0 flex space-x-1">
            {index === 0 && (
              <Button
                variant="ghost"
                className="h-6 p-1 text-neutral-500 dark:text-neutral-400"
      ...
      {isFirst && showDocumentContent && (
        <div className="text-subtle-foreground relative mt-1 flex pl-[32px] text-sm">
          {discussionLength > 1 && (
            <div
              className="absolute top-[5px] left-3 h-full w-0.5 shrink-0 bg-neutral-100 dark:bg-neutral-800" />
          )}
      ...
      <div className="relative my-1 pl-[26px]">
        {!isLast && (
          <div
            className="absolute top-0 left-3 h-full w-0.5 shrink-0 bg-neutral-100 dark:bg-neutral-800" />
        )}
            ...
            {isEditing && (
              <div className="ml-auto flex shrink-0 gap-1">
                <Button
                  ...
                  <div
                    className="flex size-5 shrink-0 items-center justify-center rounded-[50%] bg-neutral-900/40 dark:bg-neutral-50/40">
                    <XIcon className="size-3 stroke-[3px] text-white dark:text-neutral-950" />
                  </div>
                </Button>
                ...
                <Button
                  ...
                  <div
                    ...
                    <CheckIcon className="size-3 stroke-[3px] text-white dark:text-neutral-950" />
                  </div>
                </Button>
              </div>
            )}
  ...
  return (
    <DropdownMenu open={dropdownOpen} onOpenChange={setDropdownOpen} modal={false}>
      <DropdownMenuTrigger asChild onClick={(e) => e.stopPropagation()}>
        <Button
          variant="ghost"
          className={cn('h-6 p-1 text-neutral-500 dark:text-neutral-400')}>
