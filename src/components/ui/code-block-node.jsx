...
export function CodeBlockElement(props) {
  ...
  return (
    <PlateElement
      ...
      {...props}>
      <div className="relative rounded-md bg-neutral-100/50 dark:bg-neutral-800/50">
        <pre
        ...
        <div
          ...
          {isLangSupported(element.lang) && (
            <Button
              ...
              title="Format code">
              <BracesIcon className="!size-3.5 text-neutral-500 dark:text-neutral-400" />
            </Button>
          )}
          ...
          <CopyButton
            size="icon"
            variant="ghost"
            className="size-6 gap-1 text-xs text-neutral-500 dark:text-neutral-400"
    ...
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild>
        <Button
          size="sm"
          variant="ghost"
          className="h-6 justify-between gap-1 px-2 text-xs text-neutral-500 select-none dark:text-neutral-400"
          aria-expanded={open}
          role="combobox">
