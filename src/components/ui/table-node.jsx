  ...
  return (
    <Popover
      ...
      <PopoverContent
        ...
        {...props}>
        <Toolbar
          className="scrollbar-hide flex w-auto max-w-[80vw] flex-row overflow-x-auto rounded-md border border-neutral-200 bg-white p-1 shadow-md print:hidden dark:border-neutral-800 dark:bg-neutral-950"
          contentEditable={false}>
          <ToolbarGroup>
...
function RowDragHandle({
  ...
  return (
    <Button
      ...
      <GripVertical className="text-neutral-500 dark:text-neutral-400" />
    </Button>
  );
}
        ...
        <div
          ...
          {!readOnly && (
            <>
              ...
              <div
                className={cn(
                  'absolute top-0 z-30 hidden h-full w-1 bg-neutral-950 dark:bg-neutral-300',
                  'right-[-1.5px]',
              ...
              {colIndex === 0 && (
                <div
                  className={cn(
                    'absolute top-0 z-30 h-full w-1 bg-neutral-950 dark:bg-neutral-300',
                    'left-[-1.5px]',
