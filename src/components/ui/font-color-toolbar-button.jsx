  ...
  const content = (
    <DropdownMenuItem
      className={cn(buttonVariants({
        size: 'icon',
        variant: 'outline',
      }), 'my-1 flex size-6 items-center justify-center rounded-full border border-neutral-200 border-solid border-neutral-100 p-0 transition-all hover:scale-125 dark:border-neutral-800', !isBrightColor && 'border-transparent', isSelected && 'border-2 border-neutral-900 dark:border-neutral-50', className)}
